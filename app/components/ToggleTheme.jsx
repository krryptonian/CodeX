  ...
  return (
    ...
    >
      <path
        ...
        className={
          selected
            ? 'fill-yellow-400/20 stroke-yellow-200'
  ...
  return (
    <svg viewBox='0 0 24 24' fill='none' {...props}>
      <path
        ...
        className={selected ? 'fill-yellow-400/20' : 'fill-transparent'}
      />
      <path
  ...
  return (
    <svg viewBox='0 0 24 24' fill='none' {...props}>
      <path
        ...
        className={
          selected
            ? 'stroke-yellow-200 fill-yellow-400/20'
            : 'stroke-neutral-400 dark:stroke-neutral-500'
        }
      />
      <path
...
const ToggleTheme = ({ panelClassName = 'mt-4' }) => {
  ...
  return (
    <Listbox value={setting} onChange={setSetting}>
      ...
      <Listbox.Options
        className={clsx(
          'absolute z-50 top-full right-20 bg-white rounded-lg ring-1 ring-neutral-900/10 shadow-lg overflow-hidden w-36 py-1 text-sm text-neutral-700 font-semibold dark:bg-neutral-800 dark:ring-0 dark:highlight-white/5 dark:text-neutral-300',
          panelClassName
        )}
      >
